 ...
 */
final class Version20230523073139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favoris ADD CONSTRAINT FK_8933C432C3C6F69F FOREIGN KEY (car_id) REFERENCES car (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favoris DROP FOREIGN KEY FK_8933C432C3C6F69F');
